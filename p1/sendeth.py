...
def sendeth(ethernet_packet, payload, interface = "h1-eth0"):
...
if __name__ == "__main__":
    ...
    ipv4_header = [0x45, 0x00, 0x00, 0x54, 0x05, 0x9f, 0x40, 0x00, 0x40, 0x01, 0x2f, 0x93, 0x0a, 0x00, 0x02, 0x0f, 0xc3, 0x58, 0x36, 0x10]
